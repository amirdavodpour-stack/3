...
Future<void> main() async {
  ...
  runApp(MultiProvider(
    providers: [
      ...
      Provider<OfferRepository>(create: (_) => ApiOfferRepository(api)),
      Provider<TransactionRepository>(
          create: (_) => ApiTransactionRepository(api)),
      Provider<WalletRepository>(create: (_) => ApiWalletRepository(api)),
      ...
      Provider<AccountPrivacyRepository>(create: (_) => AccountPrivacyRepository(api)),
    ],
...
class WorkMarketplaceApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Do not clamp system text scaling. WCAG reflow/low-vision use cases
    // depend on users being able to enlarge text; individual responsive
    // surfaces are responsible for avoiding overflow at large scales.
    return MaterialApp(
        title: 'HOPE',
