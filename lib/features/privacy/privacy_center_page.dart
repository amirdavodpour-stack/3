          ...
          children: [
            ...
            PremiumPanel(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    _t('دریافت داده‌ها', 'Export your data'),
                  ...
                  children: [
                    Row(
                      children: [
                        Expanded(
                          child: Text(
                            _t('پیش‌نمایش خروجی', 'Export preview'),
                  ...
                  OutlinedButton.icon(
                    ...
                    label: Text(
                      _deleting
                          ...
                          : _t('حذف دائمی حساب', 'Delete account permanently'),
                    ),
                  ),
                ],
              ),
