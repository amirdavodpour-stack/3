...
export function createOfferLegacyAdapter({ db, id, now, withTransaction }) {
  return Object.freeze({
    ...
    listForJob(jobId) { return db.collection.offers.filter((o) => o.jobId === jobId); },
    listForProvider(providerId) { return db.collection.offers.filter((o) => o.providerId === providerId).sort((a,b) => String(b.createdAt).localeCompare(String(a.createdAt))); },
