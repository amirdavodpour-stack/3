...
export function createPaymentLegacyAdapter({ db, withTransaction, fundingJournal, refundJournal, releaseJournal, payoutJournal, now }) {
  ...
  return Object.freeze({
    ...
    choosePendingOffer(jobId) { return db.collection.offers.filter((o) => o.jobId === jobId && o.status === 'PENDING').sort((a, b) => { const aa=BigInt(String(a.price||'0')); const bb=BigInt(String(b.price||'0')); return aa<bb?-1:aa>bb?1:0; })[0] || null; },
