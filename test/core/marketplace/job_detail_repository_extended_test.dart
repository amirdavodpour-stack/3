...
void main() {
  ...
  test('submitOffer serializes the exact TOMAN price string and message', () async {
    server.handlers['/offers'] = (request, body) async {
      expect(body['jobId'], 'j1');
      expect(body['price'], '125');
      expect(body['message'], 'offer');
      await respondJson(request, 200, {});
    };
    await repository.submitOffer('j1', price: '125', message: 'offer');
  });
