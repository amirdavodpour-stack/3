...
void main() {
  ...
  group('HopePayment.fromMap', () {
    ...
    test('amount preserves a numeric payload as an exact string', () {
      final payment = HopePayment.fromMap({
        'job': jobPayload(),
        'amount': 125.5,
      });
    ...
    test('amount preserves a numeric string exactly', () {
      final payment = HopePayment.fromMap({
        'job': jobPayload(),
        'amount': '125.50',
      });
  ...
  group('HopePaymentFees.fromMap', () {
    test('missing policyVersion/currency fall back to legacy/TOMAN', () {
      final fees = HopePaymentFees.fromMap({});
      expect(fees.policyVersion, 'legacy');
      expect(fees.currency, 'TOMAN');
