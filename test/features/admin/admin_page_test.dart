...
class _FakeAdmin implements AdminRepository {
  ...
  @override
  Future<List<Map<String, dynamic>>> listTrustReports({String? status}) async => const [];

  @override
  Future<void> updateTrustReportStatus(String id, String status) async {}

  @override
  Future<List<Map<String, dynamic>>> listUnknownPayouts({int limit = 100}) async => const [];

  @override
  Future<Map<String, dynamic>> resolveUnknownPayout(String id, {required String decision, String? providerRef, String? reason}) async => const {};

  @override
  Future<Map<String, dynamic>> getAnalyticsSummary({int days = 30}) async => const {};
